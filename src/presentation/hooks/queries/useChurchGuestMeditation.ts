...
import { GetGuestComments } from '@/application/use-cases/church-guest-meditation/GetChurchGuestMeditations'
import { CreateGuestComment } from '@/application/use-cases/church-guest-meditation/CreateChurchGuestMeditation'
import { UpdateGuestComment } from '@/application/use-cases/church-guest-meditation/UpdateChurchGuestMeditation'
import { DeleteGuestComment } from '@/application/use-cases/church-guest-meditation/DeleteChurchGuestMeditation'
import { ToggleGuestCommentLike } from '@/application/use-cases/church-guest-meditation/ToggleChurchGuestMeditationLike'
import { GetGuestCommentReplies } from '@/application/use-cases/church-guest-meditation/GetChurchGuestMeditationReplies'
import { CreateGuestCommentReply } from '@/application/use-cases/church-guest-meditation/CreateChurchGuestMeditationReply'
import { DeleteGuestCommentReply } from '@/application/use-cases/church-guest-meditation/DeleteChurchGuestMeditationReply'
import { SupabaseGuestCommentRepository } from '@/infrastructure/repositories/SupabaseChurchGuestMeditationRepository'
import { CreateGuestCommentInput, UpdateGuestCommentInput, CreateGuestCommentReplyInput } from '@/domain/entities/ChurchGuestMeditation'
...
/** churchGuestMeditationKeys = guestCommentKeys */
export const churchGuestMeditationKeys = guestCommentKeys

/** useChurchGuestMeditations = useGuestComments */
export const useChurchGuestMeditations = useGuestComments

/** useCreateChurchGuestMeditation = useCreateGuestComment */
export const useCreateChurchGuestMeditation = useCreateGuestComment

/** useUpdateChurchGuestMeditation = useUpdateGuestComment */
export const useUpdateChurchGuestMeditation = useUpdateGuestComment

/** useDeleteChurchGuestMeditation = useDeleteGuestComment */
export const useDeleteChurchGuestMeditation = useDeleteGuestComment

/** useToggleChurchGuestMeditationLike = useToggleGuestCommentLike */
export const useToggleChurchGuestMeditationLike = useToggleGuestCommentLike

/** useChurchGuestMeditationReplies = useGuestCommentReplies */
export const useChurchGuestMeditationReplies = useGuestCommentReplies

/** useCreateChurchGuestMeditationReply = useCreateGuestCommentReply */
export const useCreateChurchGuestMeditationReply = useCreateGuestCommentReply

/** useDeleteChurchGuestMeditationReply = useDeleteGuestCommentReply */
export const useDeleteChurchGuestMeditationReply = useDeleteGuestCommentReply
