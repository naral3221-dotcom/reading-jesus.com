...
} from '@/domain/repositories/IGroupMeditationRepository'
import type {
  CommentProps,
  CreateCommentInput,
  UpdateCommentInput,
  ...
  MemberRankProps,
} from '@/domain/entities/GroupMeditation'
...
/** SupabaseGroupMeditationRepository = SupabaseCommentRepository */
export const SupabaseGroupMeditationRepository = SupabaseCommentRepository
export type SupabaseGroupMeditationRepository = SupabaseCommentRepository
