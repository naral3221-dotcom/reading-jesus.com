...
/** IGroupMeditationRepository = ICommentRepository */
export type IGroupMeditationRepository = ICommentRepository

/** GroupMeditationSearchParams = CommentSearchParams */
export type GroupMeditationSearchParams = CommentSearchParams

/** GroupMeditationWithLikeStatus = CommentWithLikeStatus */
export type GroupMeditationWithLikeStatus = CommentWithLikeStatus
