...
// ===== 새 명명 체계 별칭 =====
// ChurchGuestMeditation으로 점진적 마이그레이션 지원

/** ChurchGuestMeditationProps = GuestCommentProps */
export type ChurchGuestMeditationProps = GuestCommentProps

/** CreateChurchGuestMeditationInput = CreateGuestCommentInput */
export type CreateChurchGuestMeditationInput = CreateGuestCommentInput

/** UpdateChurchGuestMeditationInput = UpdateGuestCommentInput */
export type UpdateChurchGuestMeditationInput = UpdateGuestCommentInput

/** ChurchGuestMeditationReplyProps = GuestCommentReplyProps */
export type ChurchGuestMeditationReplyProps = GuestCommentReplyProps

/** CreateChurchGuestMeditationReplyInput = CreateGuestCommentReplyInput */
export type CreateChurchGuestMeditationReplyInput = CreateGuestCommentReplyInput

/** ChurchGuestMeditationLikeProps = GuestCommentLikeProps */
export type ChurchGuestMeditationLikeProps = GuestCommentLikeProps

/** ChurchGuestMeditation = GuestComment */
export const ChurchGuestMeditation = GuestComment
export type ChurchGuestMeditation = GuestComment

/** ChurchGuestMeditationReply = GuestCommentReply */
export const ChurchGuestMeditationReply = GuestCommentReply
export type ChurchGuestMeditationReply = GuestCommentReply
